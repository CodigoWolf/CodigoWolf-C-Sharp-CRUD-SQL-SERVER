        ...
        <div class="row ocultar">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input type="file" id="archivo" name="archivo" data-imagen="Prueba Subir Imagen" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                ...
                                <input type="button" id="upload" name="upload" value="Upload" class="btn btn-primary" />
                            </div>
                        </div>
                    </div>
